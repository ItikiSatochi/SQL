-----PROJETO DE UM BILIOTECA PARA O GITHUB----------
...
CREATE TABLE Editoras (
    Editora_ID          int PRIMARY KEY IDENTITY,
    Nome                VARCHAR (100),
    Pais                VARCHAR (100)
);

CREATE TABLE Generos (
    Genero_ID           INT PRIMARY KEY IDENTITY,
    Descricao           VARCHAR(100)
)

CREATE TABLE Livros (
    Livro_ID            INT PRIMARY KEY IDENTITY,
    Titulo              VARCHAR (100),
    Publicacao          INT,
...
CREATE TABLE Regioes (   --Nova tabela para adicionar na tabela 
...
CREATE TABLE Precos (  ----Nova table para adcionar na tabela 
    Preco_ID            INT PRIMARY KEY IDENTITY,
    Livro_ID            INT FOREIGN key REFERENCES Livros(Livro_ID), --Fazendo uma referencia a tabela Livros usando o FOREING
...
CREATE TABLE Emprestimos_Oline (  ----Nova table para adcionar na tabela 
    Emprestimo_Online   INT PRIMARY KEY IDENTITY,
    Livro_ID            INT FOREIGN KEY REFERENCES Livros(Livro_ID),  -- Fazendo uma referencia a tabela Livros usando o FOREING
    Usuario_ID          INT FOREIGN key REFERENCES Usuarios(Usuario_ID), --Fazendo uma referencia a tabela Usuarios usando o FOREING
    Data_Emprestimo     DATE,
    Data_Devolucao      DATE,
